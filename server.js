...
const app = express();
const HOST = process.env.HOST || '0.0.0.0'; // Changed from 127.0.0.1 to allow better connectivity
...
let products = [
  { id: "p1", name: "Aloo Bhujia (Sale)", price: 22, originalPrice: 30, badge: "🔥 SALE!", badgeColor: "#dc3545", image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=800&q=80" },
  { id: "p2", name: "Bikaneri Bhujia", price: 35, image: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=800&q=80" },
  { id: "p3", name: "Ratlami Sev", price: 25, image: "https://images.unsplash.com/photo-1613292443284-8d10ef9383fe?auto=format&fit=crop&w=800&q=80" },
  { id: "p4", name: "Nylon Sev", price: 28, image: "https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?auto=format&fit=crop&w=800&q=80" },
  ...
  { id: "p6", name: "Bombay Mix", price: 45, image: "https://images.unsplash.com/photo-1589301760014-d929f39ce9de?auto=format&fit=crop&w=800&q=80" },
  { id: "p7", name: "Navratan Mixture", price: 50, image: "https://images.unsplash.com/photo-1605807646983-377bc5a76493?auto=format&fit=crop&w=800&q=80" },
  { id: "p8", name: "Chivda (Poha Mix)", price: 35, image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=800&q=80" },
  ...
  { id: "p10", name: "Masala Peanuts", price: 35, image: "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?auto=format&fit=crop&w=800&q=80" },
  { id: "p11", name: "Salted Peanuts", price: 28, image: "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?auto=format&fit=crop&w=800&q=80" },
  { id: "p12", name: "Hing Sev", price: 32, image: "https://images.unsplash.com/photo-1613292443284-8d10ef9383fe?auto=format&fit=crop&w=800&q=80" },
  { id: "p13", name: "Tikha Sev", price: 30, image: "https://images.unsplash.com/photo-1613292443284-8d10ef9383fe?auto=format&fit=crop&w=800&q=80" },
...
function persistNow() {
  try {
    ...
    const payload = JSON.stringify({ carts, orders, users, reviews, products }, null, 2);
